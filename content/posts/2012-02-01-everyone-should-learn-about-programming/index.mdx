...
---
What use have an artist, a baker, a winemaker, a firefighter and a brewer with [programming](http://en.wikipedia.org/wiki/Computer_programming "Computer programming")? None.



\[caption id="" align="alignright" width="346" caption="A brewer"]![A brewer](./img/blog-wp-content-uploads-2012-02-sissons_brewer_199710.jpg "A brewer")\[/caption]
...
An article surfaced on [HackerNews](http://news.ycombinator.com/ "Hacker News") yesterday arguing that [Programming is the new High School Diploma](http://news.ycombinator.com/item?id=3528940), the main argument being two facts:
...
\[caption id="" align="alignright" width="300" caption="Image via Wikipedia"][![Washington, D.C. firefighter](./img/blog-wp-content-uploads-2012-02-300px-DC_firefighter2.jpg "Washington, D.C. firefighter")](http://commons.wikipedia.org/wiki/File:DC_firefighter.jpg)\[/caption]
...
\[caption id="" align="alignleft" width="181" caption="A chef"]![A chef](./img/blog-wp-content-uploads-2012-02-chef1.jpg "A chef")\[/caption]



And yet high school deprives us of even the simplest knowledge of a field touching _everything_ in our lives.



To innovate, to even begin to really use this amazing tool, we need to give the general populace the ability to begin the process of automation - that spark of _Hey, this is kind of repetitive, I wonder if a computer could do it._
...
Give them the bug of automation. Do it with passion. Do it well. When they start looking at the world in terms of _Hmm ... I wonder how this could be made better, easier, more interesting._They will start coming back with real problems. Problems out of their solution scope, but something _you_ can work on.
