...
\[caption id="attachment_5506" align="alignright" width="184"][![Default bootstrap example - zoomable etc.](http://swizec.com/blog/wp-content/uploads/2012/11/default-bootstrap-example.png "Default bootstrap example - zoomable etc.")](./img/blog-wp-content-uploads-2012-11-default-bootstrap-example.png) Default bootstrap example - zoomable etc.\[/caption]
