...
Anyway, we made some progress from [last time](https://swizec.com/blog/livecoding-38-faux-ai-writes-javascript/swizec/7607). Our evolutionary approach still gets stuck in a local maximum after just a few iterations, but it no longer gets stuck on a single solution.
