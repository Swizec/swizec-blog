...
hero: ./img/blog-wp-content-uploads-2016-12-Screen-Shot-2016-12-07-at-00.15.52.png
---
...
![](./img/blog-wp-content-uploads-2016-12-Screen-Shot-2016-12-07-at-00.15.52.png)



That's funny ... UglifyJS throws an error on the first line of my [better-fetch](https://swizec.com/blog/a-tiny-es6-fetch-wrapper/swizec/7177) library. Why would it do _that_? ?
...
![](./img/blog-wp-content-uploads-2016-12-i-built-a-sfaehy.jpg)
...
3.73 months ago, I thought [packaging a library was hard](https://swizec.com/blog/livecoding-19-its-hard-to-package-a-library/swizec/6927). Turns out it's not so bad at all.
