...
date: 2018-02-23
redirect_from: 
            - /blog/why-everything-must-change-every-five-years/swizec/8212
author: Swizec Teller
hero: ./img/blog-wp-content-uploads-2018-02-change.png
---
![](./img/blog-wp-content-uploads-2018-02-change.png)



You complain about [JavaScript fatigue](https://www.google.com/search?q=javascript+fatigue&oq=javascript+fatigue&aqs=chrome..69i57j0l3.2712j0j1&sourceid=chrome&ie=UTF-8), and that's valid. The ecosystem moves fast, and it's hard to keep up. Dare I say impossible?
...
[Software Engineering is growing at about 24% per decade](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm). You can't build a training industry on that. Not a big one anyway.



![](./img/media-cEYFeDKVPTmRgIG9fmo-giphy.gif)
...
Create new bundlers and compilers and tell everyone that JavaScript must be compiled – it's really much better that way. Invent a whole new way to talk to backends because REST and Ajax are lame.



Don't tell anyone that all these things are pretty much the same as always behind the scenes. You still need Ajax to talk to the backend, everything still turns into HTML in the end, and CSS still winds up a bunch of `<style>` tags no matter what bundler you use. 🤫
