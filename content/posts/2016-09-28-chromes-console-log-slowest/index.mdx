...
1.  Playing with the dataset is in progress; pretty pictures in a week or two. [↩︎](#fnr1-30036 "return to article")
2.  Tests were run manually in each browser. The graph shows average time for each operation. [↩︎](#fnr2-30036 "return to article")
