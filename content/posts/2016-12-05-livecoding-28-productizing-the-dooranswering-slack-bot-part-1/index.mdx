...
date: 2016-12-05
redirect_from: 
            - /blog/livecoding-28-productizing-the-door-answering-slack-bot-part1/swizec/7267
author: Swizec Teller
hero: ./img/blog-wp-content-uploads-2016-12-Screen-Shot-2016-12-05-at-00.44.43.png
---
...
On Wednesday, the founder walked up to my desk and said: _"If you don't get that Slack bot set up, we're routing the buzzer phone number to your phone. I'm not joking."_
...
But first, some background. He was talking about [the Twilio+Slack bot](https://swizec.com/blog/make-slack-twilio-talk/swizec/7128) I [started building](https://swizec.com/blog/livecoding-22-a-door-answering-slackbot/swizec/7038), and [almost finished](https://swizec.com/blog/livecoding-23-slackbots-oauth/swizec/7065) in September. I had a working prototype running on my localhost some time in October.



When I showed it to the coworker who's currently stuck answering the door, she loved it. Super excited. She's been giving me glares for the past 2 months. _"Where is my fucking bot!?"_ the glares ask.
...
In my defense, I _meant_ to do it this whole time, but I was busy putting together the [React Indie Bundle](http://www.reactindiebundle.com).
...
![](./img/blog-wp-content-uploads-2016-12-Screen-Shot-2016-12-05-at-00.44.43.png)
...
To make OpenMyDoor _actually_ useful, I have to add a database. Something simple to keep track of which OAuth token belongs to which phone number and Slack channel. Then we'll be able to route Twilio calls to correct teams.
