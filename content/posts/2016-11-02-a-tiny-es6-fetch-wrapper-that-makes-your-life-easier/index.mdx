...
---
After [yesterday's shenanigans](link) with ES6 fetch(), I made a tiny library called [better-fetch](https://github.com/Swizec/better-fetch) which makes your life easier. Or at least it makes _my_ life easier.
