...
hero: ./img/<address>?t=<type>&v=<value>&b=<bucket>
---
...
If all goes well, I will soon be able to use cubism.js to draw a pretty timeseries of the traffic on this blog. And hey, who knows what else I can think of to add to a personal dashboard of my life ... I now have the basic framework. Time to start using it. [![Cubism.js makes shiny timeseries](./img/cubismjs-shiny-timeseries.png "Cubism.js makes shiny timeseries")](http://square.github.com/cubism/)
