...
\[caption id="" align="alignnone" width="367" caption="A software architect's dream"]![A software architect's dream](http://distilleryimage0.instagram.com/1d60c314b6de11e1a9f71231382044a1_7.jpg "A software architect's dream")\[/caption]
...
Where _type_ is one of _c_(counter)_, t_(timer)_, g_(gauge)_._ As per StatsD naming convention. And _bucket_ is simply the name of your metric.
...
[![Cubism.js makes shiny timeseries](./img/blog-wp-content-uploads-2012-06-cubismjs-shiny-timeseries.png "Cubism.js makes shiny timeseries")](http://square.github.com/cubism/)
