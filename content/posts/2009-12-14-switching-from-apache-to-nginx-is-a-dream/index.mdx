...
This isn't bad. Of course when you first start using [mod_rewrite](http://en.wikipedia.org/wiki/Rewrite_engine "Rewrite engine") you're going to have to change things and naturally adding a new website on a new domain means changing a few things. No problem here, all natural.
...
So there you go @[robertbasic](http://twitter.com/robertbasic "Robert Basic"), @genom, @loudandwicked, @jaspertandy ... a blog post about the change.
