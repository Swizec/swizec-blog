...
hero: ./img/blog-wp-content-uploads-2012-10-mocha-testing.png
---
\[caption id="" align="alignnone" width="438" caption="Basic idea from THE Bret Victor talk"]![Basic idea from THE Bret Victor talk](http://icant.co.uk/talks/h5/pictures/smashingconf/shorterjourney.jpg "Basic idea from THE Bret Victor talk")\[/caption]
...
Most of our a developer's revolves around verifying code. After [hitting the limit of how fast you can type](http://swizec.com/blog/ive-hit-a-glass-ceiling-of-coding-productivity-now-what/swizec/5191 "I’ve hit a glass ceiling of coding productivity. Now what?"), the only way to think faster is getting feedback instantly.
...
First of all, you should write tests. No need for full on TDD writing tests before writing code, just have tests, _any_ tests. Because eventually you will want to know if this thing you've just coded works.
...
\[caption id="attachment_5386" align="alignright" width="307" caption="Mocha automated automated testing"][![Mocha automated automated testing](http://swizec.com/blog/wp-content/uploads/2012/10/mocha-testing.png "Mocha automated automated testing")](./img/blog-wp-content-uploads-2012-10-mocha-testing.png)\[/caption]
...
Then again, I've got an automated test suite, why am I running it manually? Wouldn't it be better if something ran the test suite every time I hit _Ctrl+S_?
...
Let [automated testing](http://en.wikipedia.org/wiki/Test_automation "Test automation") run automatically and just glance at the results every so often. You won't break concentration, you won't be tempted to check twitter while the tests run, you won't have to get out of your [text editor](http://en.wikipedia.org/wiki/Text_editor "Text editor").
