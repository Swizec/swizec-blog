...
Ok so I've tried numerous things to get myself organised; everything from entering TODO's into [Evernote](http://www.evernote.com "Evernote"), to [Mac](http://en.wikipedia.org/wiki/Macintosh "Macintosh") widget thingies and the pretty awesome [Things](http://culturedcode.com/things/) app and just plain writing stuff on a [whiteboard](http://en.wikipedia.org/wiki/Whiteboard "Whiteboard") and erasing it when it's done.
...
And then along comes [Workflowy](http://workflowy.com) with a small post on HackerNews saying "Hey, we're from YC2k9 and we've launched. We help you organize your brain" (this was a week or two ago)
...
Everything you write on Workflowy is a nested bulletpoint list. This is where it gets mindblowingly awesomer than an old fashioned [TODO list](http://en.wikipedia.org/wiki/Time_management "Time management").
...
[![](http://swizec.com/blog/wp-content/uploads/2010/11/Screen-shot-2010-11-24-at-12.33.17-AM.png "Workflowy example")](./img/blog-wp-content-uploads-2010-11-Screen-shot-2010-11-24-at-12.33.17-AM.png)
...
Actually the only thing I dislike right now is that it doesn't work on [mobile devices](http://en.wikipedia.org/wiki/Mobile_device "Mobile device"), not even tablets. Just gives you a warning that hey, you're a smartphone, fuck you and come back later when we do support you.
...
_Update: apparently a MVP of mobile support is due to come out in a few days._
