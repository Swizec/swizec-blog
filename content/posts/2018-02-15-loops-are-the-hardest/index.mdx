...
\[codepen_embed height="365" theme_id="0" slug_hash="oYNvpQ" default_tab="js,result" user="swizec"]See the Pen [d3 color scale](https://codepen.io/swizec/pen/oYNvpQ/) by Swizec Teller ([@swizec](https://codepen.io/swizec)) on [CodePen](https://codepen.io).\[/codepen_embed]
...
\[codepen_embed height="565" theme_id="0" slug_hash="BYdZXd" default_tab="js,result" user="swizec"]See the Pen [d3 color checkerboard](https://codepen.io/swizec/pen/BYdZXd/) by Swizec Teller ([@swizec](https://codepen.io/swizec)) on [CodePen](https://codepen.io).\[/codepen_embed]
