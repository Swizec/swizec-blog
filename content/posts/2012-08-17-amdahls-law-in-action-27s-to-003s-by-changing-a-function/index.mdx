...
hero: ./img/wikipedia-commons-thumb-6-6b-AmdahlsLaw.png-300px-AmdahlsLaw.png
---
...
\[caption id="" align="alignright" width="300" caption="Graph Illustrating Amdahl's Law (Photo credit: Wikipedia)"][![Graph Illustrating Amdahl's Law](./img/wikipedia-commons-thumb-6-6b-AmdahlsLaw.png-300px-AmdahlsLaw.png "Graph Illustrating Amdahl's Law")](http://commons.wikipedia.org/wiki/File:AmdahlsLaw.png)\[/caption]



![Amdahl's law](./img/wikipedia-en-math-8-9-6-89638a25639297d701f9298b68ee9cec.png "Amdahl's law")
...
The [levenshtein distance function I implemented](http://swizec.com/blog/levenshtein-distance-in-haskell/swizec/4801 "Levenshtein distance in Haskell") costs 100% of [computation time](http://en.wikipedia.org/wiki/Time_complexity "Time complexity")!
