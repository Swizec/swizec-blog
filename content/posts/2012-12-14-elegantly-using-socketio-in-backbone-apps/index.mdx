...
Both of these approaches result in _this.button_clicked_being called when a user clicks the button. Except the second approach is much easier on the eye and significantly less convoluted when you have ten different events doing things.
...
I usually keep the socket in the global _App_object.
