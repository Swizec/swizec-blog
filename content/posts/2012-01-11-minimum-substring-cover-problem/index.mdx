...
\[caption id="" align="alignright" width="213" caption="Image by Shreyans Bhansali via Flickr"][![algorithms doodle](./img/blog-wp-content-uploads-2012-01-11259239_fe6b60af02_m5.jpg "algorithms doodle")](http://www.flickr.com/photos/94416001@N00/11259239)\[/caption]
...
Depending on how you choose the weight, both C_1 and C_2 are _minimum substring covers_ of S. Considering "least" to mean _least amount of strings_ then both are of weight 2, but if you consider "least" to mean _the total length of strings_ then C_1 is better.
