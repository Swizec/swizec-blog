...
date: 2017-06-06
redirect_from: 
            - /blog/2890-may-sidehustle-report/swizec/7626
author: Swizec Teller
hero: ./img/blog-wp-content-uploads-2017-06-starbucks-salary.png
---
...
Most of the month went towards building a React Native Music App: [Part 1](https://school.shoutem.com/lectures/build-react-native-music-app-tutorial-part1/) and [Part 2](https://school.shoutem.com/lectures/react-native-soundcloud-streaming-app-tutorial-part-2/). Subscribers on the React Native School project still aren't growing as fast as I'd like. Gonna have to figure something out.
...
Another big portion of the month went towards completing [React + D3v4](https://gum.co/mTWg). IT IS FUNCTIONALLY COMPLETE \\o/
...
![](./img/blog-wp-content-uploads-2017-06-starbucks-salary.png)
