...
date: 2017-12-07
redirect_from: 
            - /blog/teaching-backend-devs-react-redux-stubhub-boston/swizec/7952
author: Swizec Teller
hero: ../../../defaultHero.jpg
---
https&#x3A;//youtu.be/EEsN7ucZBq4



_"Did you learn a lot?"_ I asked after a two day workshop where we covered everything from wtf is destructuring to redux thunks.



_"LoL No! We barely scratched the surface, but you gave us a good head start. If this is what is required of us, we'll learn it for real.”_
...
_"Ok, that's what Redux **does**. But what **is** Redux?"_
...
_"Thank you. Proceed.”_



My middle school math teacher would always do that. What is a square? _"It has four sides, and all sides are equal, and they are at right angles.”_ Okay, those are a square's properties, but what _is_ it?
...
You see, we came into this workshop, [Real World React](https://www.meetup.com/Real-World-React/) and I, thinking that we were going to train a StubHub Boston team much like we did in San Francisco. A bunch of engineers who have heard of React and Redux, played around with them, and want some quick leveling up. Get up to speed with the new direction the company frameworks are taking.
...
We talked about how life was simpler back in 1998 when JavaScript was just a new toy on the block that was fun and whimsical. That's when most of them used it last.



https&#x3A;//www.instagram.com/p/BcVFV3TFGpq/
