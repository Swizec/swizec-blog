...
---
[![A test bed](http://swizec.com/blog/wp-content/uploads/2012/12/Selection_090.png "A test bed")](./img/blog-wp-content-uploads-2012-12-Selection_090.png)
...
As you can see, my testing harness has a _div#view_where things render, then I tell the App to go into a certain state and check the correct view has rendered.
