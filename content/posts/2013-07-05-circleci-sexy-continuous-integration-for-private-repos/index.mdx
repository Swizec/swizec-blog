...
\[caption id="" align="alignnone" width="667"]![CircleCI dashboard](https://www.filepicker.io/api/file/PI3LtjaZQRaz2ZB2GOfM "CircleCI dashboard") CircleCI dashboard\[/caption]



The first thing we fixed at [Dwellers](http://dwellers.com), was setting up a [continuous integration](http://en.wikipedia.org/wiki/Continuous_integration "Continuous integration") service on the very first day. I've never worked with an environment that makes sure all my tests are passing and pushes things into staging before. I tried a few years ago, but it was a bitch to set up and never worked.
...
Sure I run tests all the time, and have no problem deploying to a server - especially [Heroku](http://www.heroku.com/ "Heroku") where you just do a `git push heroku`. But it's tedious and the less things you have to think about, the more brain cycles are free to solve actual problems.



Initially I suggested using [TravisCI](https://travis-ci.org/) but they _still_ don't support private repositories. Luckily we found [CircleCI](https://circleci.com/). It focuses exclusively on private [Github](http://github.com "GitHub") repositories. Perfect.
...
\[caption id="" align="alignnone" width="600"]![A CircleCI test run](https://www.filepicker.io/api/file/tu573fdfRCKQQjlrS2hz "A CircleCI test run") A CircleCI test run\[/caption]
...
\[caption id="" align="alignnone" width="657"]![Test badges in branch list](https://www.filepicker.io/api/file/bzq7m0YxTaCLMzn39JaZ "Test badges in branch list") Test badges in branch list\[/caption]
