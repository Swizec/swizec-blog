...
\[caption id="" align="alignright" width="300" caption="Parse tree of Python code with inset tokenization (Photo credit: Wikipedia)"][![Parse tree of Python code with inset tokenization](http://upload.wikimedia.org/wikipedia/en/thumb/a/ac/Python_add5_parse.png/300px-Python_add5_parse.png "Parse tree of Python code with inset tokenization")](http://en.wikipedia.org/wiki/File:Python_add5_parse.png)\[/caption]
...
\[caption id="" align="alignright" width="300" caption="FPGARetrocomputing (Photo credit: Wikipedia)"][![FPGARetrocomputing](./img/wikipedia-commons-thumb-c-c9-FPGARetrocomputing.jpg-300px-FPGARetrocomputing.jpg "FPGARetrocomputing")](http://commons.wikipedia.org/wiki/File:FPGARetrocomputing.jpg)\[/caption]
...
And keep in mind that finding the bugs in the first place is **really hard_._**The professor gave my very buggy compiler a 100%. Simply because every program _he_ ran worked.
