...
\[caption id="" align="alignnone" width="504"]![Completely random graph](./img/images-23704.png "Completely random graph") Completely random graph\[/caption]
...
\[caption id="" align="alignnone" width="490"]![Moving random graph](./img/images-23705.gif "Moving random graph") Moving random graph\[/caption]
...
\[caption id="" align="alignnone" width="490"]![Fixed random graph, 1](./img/images-23706.gif "Fixed random graph, 1") Fixed random graph, 1\[/caption]
...
\[caption id="" align="alignnone" width="490"]![Fixed random graph, 2](./img/images-23707.gif "Fixed random graph, 2") Fixed random graph, 2\[/caption]
...
\[caption id="" align="alignnone" width="490"]![Fixed random graph, 3](./img/images-23708.gif "Fixed random graph, 3") Fixed random graph, 3\[/caption]
...
\[caption id="" align="alignnone" width="490"]![Moving graph, good](./img/images-23710.gif "Moving graph, good") Moving graph, good\[/caption]
