...
hero: ./img/screenshot-1.png
---

10 years of love for Emacs undone by a week in VSCode. 🤔 https&#x3A;//youtu.be/8kCd4w4kc68 Last week, I wrote about [Why I won't be switching to VSCode any time soon](https://swizec.com/blog/wont-be-switching-vscode/swizec/7898). Then [Cunningham's law](https://meta.wikimedia.org/wiki/Cunningham's_Law) kicked in, I learned about some killer features, got tips on some config, and gave VSCode another chance. https&#x3A;//twitter.com/\_developit/status/926509015672160256 That was the one. The feature that made me try VSCode for real. You can hover any function or variable, press command, and see its definition in a little popup. Or jump straight to the code. 😍 I think I have the perfect config going, and I'd share it with you, but I don't know how. Mainly I focused on getting a clean interface where code dominates. ![](./img/screenshot-1.png) Blank slate with a bunch of code. The status bar is subtle, no activity bar, no cruft to the left or right of the code. No ugly vertical lines showing indentation. Change indicators still show up as subtle green or blue lines. ![](./img/screenshot-2.png) It's great. Here's some stuff that still annoys me 👇
