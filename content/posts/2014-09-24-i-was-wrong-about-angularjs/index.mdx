...
---
\[caption id="" align="alignnone" width="640"]![Here be dragons](./img/images-21380.jpg "Here be dragons") Here be dragons\[/caption]



I started using Angular a few months ago. I hated it. Backbone was _so much_ better.
...
And I never liked how much logic Angular hides from you. When I work on something, I want to understand the whole system. Having a bunch of _"Here be dragons, don't go here"_ signposts everywhere feels weird.
...
Turns out Angular was messing up the event cycle and tried to update something before a different thing made it ready to be updated. Yes, very descriptive, I know. But Angular's _"This thing can't be called, derp"_ was super helpful too.
