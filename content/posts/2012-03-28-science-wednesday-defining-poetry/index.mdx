...
hero: ./img/wikipedia-commons-thumb-4-48-Alexander_Blok_-_Noch%2C_ulica%2C_fonar%2C_apteka.jpg-300px-Alexander_Blok_-_Noch%2C_ulica%2C_fonar%2C_apteka.jpg
---
...
Poetry is simple to define - _a [poem](http://en.wikipedia.org/wiki/Poetry "Poetry") is a poem because people consider it a poem._
...
\[caption id="" align="alignright" width="300" caption="Alexander Blok's poem "][![Alexander Blok's poem 'Noch, ulica, fonar, apt...](./img/wikipedia-commons-thumb-4-48-Alexander_Blok_-_Noch%2C_ulica%2C_fonar%2C_apteka.jpg-300px-Alexander_Blok_-_Noch%2C_ulica%2C_fonar%2C_apteka.jpg "Alexander Blok's poem 'Noch, ulica, fonar, apt...")](http://commons.wikipedia.org/wiki/File:Alexander_Blok_-_Noch%2C_ulica%2C_fonar%2C_apteka.jpg)\[/caption]



When you are [studying poetry](http://swizec.com/blog/science-wednesday-towards-a-computational-model-of-poetry-generation/swizec/3855) in a scientific context, even [creating a poetry generator](https://github.com/Swizec/Le-Thesis) for your graduation thesis, you need a definition that goes beyond intuitive notions of poetry.



Specifically, you need [falsifiable](http://en.wikipedia.org/wiki/Falsifiability "Falsifiability") results, a way to decide what piece of text is gibberish and what is poetry. Answering the question "Is this art?" is impossible, so Manurung came up with a better definition of poetry in his doctorate thesis _[An evolutionary algorithm for poetry generation](http://academic.research.microsoft.com/Paper/2348039.aspx)._
...
Usual suspect properties of poetry apply here, exactly the ones you learned about in high school. Things such as rhythm, metre, [phonemic](http://en.wikipedia.org/wiki/Phoneme "Phoneme") patterns and [figurative language](http://en.wikipedia.org/wiki/Literal_and_figurative_language "Literal and figurative language").
...
\[caption id="attachment_4084" align="alignnone" width="399" caption="Ambiguity in partitioning metre into feet"][![Ambiguity in partitioning metre into feet](http://swizec.com/blog/wp-content/uploads/2012/03/metre.png "Ambiguity in partitioning metre into feet")](./img/blog-wp-content-uploads-2012-03-metre.png)\[/caption]
...
For instance: according to _hyperbaton_(a defined figure of speech) the line "I was in my life alone" is allowed, but "In I life was alone my" is just silly.

## Meaningfulness

\[caption id="" align="alignright" width="186" caption="Poetry is an... (Photo credit: liber(the poet);)"][![Poetry is an...](./img/2523-4236215697_595587b794_m.jpg "Poetry is an...")](http://www.flickr.com/photos/22179411@N06/4236215697)\[/caption]



Simply put, the property of meaningfulness states that a text must _intentionally_ convey some sort of conceptual message that can be interpreted. This holds true for any [Natural Language Generation](http://en.wikipedia.org/wiki/Natural_language_generation "Natural language generation") system and despite what first year english majors might think, it must also hold true for poetry.



Keyword being _intentionally_. The above poem produced by ELUAR primarily hinges on unguided random processes, so it cannot possibly fulfill this requirement.
...
Since we can measure the technical aspects of poeticness, this definition favors classical poetry - a good thing, since I personally have always found modern poetry to be somewhat contrived in its desperate attempts to be _art_.
