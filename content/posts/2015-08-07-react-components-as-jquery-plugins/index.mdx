...
_"A-ha!"_, I thought, _"This is a job for [React+d3.js](http://swizec.com/reactd3js)!"_. Small, well-contained, perfect. The best kind of project for testing new technologies.
