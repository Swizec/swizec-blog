...
Here comes the interesting part: subscribing to web push notifications. This is where we ask the browser _"Hey, which push service do you wanna use?"_ The process has 2 to 3 steps depending on how you count 👇
