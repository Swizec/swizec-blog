...
hero: ./img/blog-wp-content-uploads-2011-11-Conlie_postcard.jpg
---
The first [postcard](http://en.wikipedia.org/wiki/Postcard "Postcard") is said to have appeared in 1840 - it was a hand painted design on a piece of thick paper, sent with a penny black stamp to the writer [Theodore Hook](http://en.wikipedia.org/wiki/Theodore_Hook "Theodore Hook").



\[caption id="" align="alignright" width="250" caption="First postcard"]![](./img/blog-wp-content-uploads-2011-11-Conlie_postcard.jpg "First postcard")\[/caption]



Since then not much has changed, the stock image postcards appeared in1848 as part of some sort of advertising. The modern postcard was born around 1870 when [Camp Conlie](http://en.wikipedia.org/wiki/Camp_Conlie "Camp Conlie") started offering stock postcards with photos of the place to send home as a memory.



_tl;dr -> [postme.me](http://postme.me) is making postcards cool again_
...
That's it. _That_ is a _five billion dollar industry_. Or so I've heard ... either way, something as lame as that is big business.
...
But we share _so many_ pictures every freaking day. Imgur is booming right now, it's the 4chan for the everyman and it is absolutely brimming with silly pictures ... often seasonal and very meaningful pictures.



When my friend had a birthday two weeks ago she didn't get a single [greeting card](http://en.wikipedia.org/wiki/Greeting_card "Greeting card"). She got ten silly pictures on facebook and somebody even made her a custom rage comic. That's right, a rage comic just to wish her a happy birthday.
...
When I started [postme.me](http://postme.me) I didn't have a vision, I just wanted to make something fun. But I think there is an underlying reason why everyone likes the idea so much, young people don't care about boring, we want fun postcards.
