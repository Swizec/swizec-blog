...
\[caption id="attachment_4326" align="alignright" width="300" caption="Schizophrenic?"][![Schizophrenic?](./img/blog-wp-content-uploads-2012-05-Summer_Glau_as_River_Tam_in_Serenity_Wallpaper__yvt2-300x225.jpg "Schizophrenic?")](http://swizec.com/blog/wp-content/uploads/2012/05/Summer_Glau_as_River_Tam_in_Serenity_Wallpaper__yvt2.jpg)\[/caption]
...
\[caption id="attachment_4329" align="alignright" width="369" caption="fp, by okeef creations"][![fp, by okeef creations](./img/blog-wp-content-uploads-2012-05-fp1.png "fp, by okeef creations")](http://www.okeefecreations.com/)\[/caption]
...
__ But I kept at it. And even though my code looked horrible, I fell in love.
...
Sure, you could define a function called _X_ that combines _Y, Z, A_and _B,_but why create a new function for something that only gets called once? Much better to just do something like _X = A+B(Y(Z))_ isn't it?

## A waterfall of data

\[caption id="attachment_4322" align="alignright" width="350" caption="Plitvice falls"][![Plitvice falls](http://swizec.com/blog/wp-content/uploads/2012/05/waterfall-of-data.jpg "Plitvice falls")](./img/blog-wp-content-uploads-2012-05-waterfall-of-data.jpg)\[/caption]
