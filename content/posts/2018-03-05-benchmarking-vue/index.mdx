...
hero: ./img/blog-wp-content-uploads-2018-03-component-screenshot.png
---
...
_This article builds on my previous articles about [Building an interactive DOM benchmark](https://swizec.com/blog/building-interactive-dom-benchmark-preliminary-results/swizec/8219) and [Adding Preact to a React project](https://swizec.com/blog/seamlessly-render-preact-component-react-project/swizec/8224)_
...
\[caption id="attachment_8239" align="alignnone" width="800"]![The Vue benchmark component](./img/blog-wp-content-uploads-2018-03-component-screenshot.png) The Vue benchmark component\[/caption]
...
Remember my [blockchain-redux](https://swizec.com/blog/blockchain-redux-experiment-part-2/swizec/8055) experiment from December? I want to use it to make [this DOM benchmark](https://dom-benchmark.now.sh/) collaborative.
