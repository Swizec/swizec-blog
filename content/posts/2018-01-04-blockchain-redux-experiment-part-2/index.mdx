...
hero: ./img/blog-wp-content-uploads-2018-01-carbon-feature-parity.png
---
...
When I last wrote about this [blockchain-backed Redux clone in 105 lines of code](https://swizec.com/blog/blockchain-backed-redux-clone-105-lines-code/swizec/7980), it could:
...
\[caption id="attachment_8053" align="alignnone" width="1506"]![Basically this is it, this is Redux](./img/blog-wp-content-uploads-2018-01-carbon-feature-parity.png) Basically this is it, this is Redux\[/caption]
...
\[caption id="attachment_8054" align="alignnone" width="1606"]![Sharing the chain between nodes using Firebase](./img/blog-wp-content-uploads-2018-01-carbon-firebase-blockchain-sharing.png) Sharing the chain between nodes using Firebase\[/caption]
